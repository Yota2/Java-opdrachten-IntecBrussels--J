...
public class PatientApp {
    public static void main(String[] args) {
        ...
        System.out.println("-----------------------------------------------------------------------------");
        System.out.println("With Duplicate Arraylist values");
        System.out.println("-----------------------------------------------------------------------------");
        allPatients.forEach(patient -> System.out.println(patient));
        Set<Patient> set = new LinkedHashSet<>(allPatients);
        allPatients.clear();
        System.out.println("---------------------------------------------------------------------------");
        ...
        System.out.println("-----------------------------------------------------------------------------------------");
        List<Patient> uniquiePatient = new ArrayList<>();
        uniquiePatient.addAll(set);
        uniquiePatient.sort(new AgeSorter());
        uniquiePatient.forEach(System.out::println);
        System.out.println("-----------------------------------------------------------------------------------------");
        System.out.println("Priority patient");
        System.out.println("-----------------------------------------------------------------------------------------");
        List<Patient> proList = new ArrayList<>();
        proList.addAll(set);
        proList.sort(new PriorityComperator());
